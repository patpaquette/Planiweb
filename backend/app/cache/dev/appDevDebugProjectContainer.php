...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/annotations', true);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'Planiweb', 'host' => '127.0.0.1', 'port' => 8889, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_81b4d10fdc283c5887e5f70a042d24bb');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_81b4d10fdc283c5887e5f70a042d24bb');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_81b4d10fdc283c5887e5f70a042d24bb');
        ...
        $e->setProxyDir('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/jms_serializer'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev',
            ...
            'debug.container.dump' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/profiler',
            ...
            'router.resource' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/dev/fos_rest',
