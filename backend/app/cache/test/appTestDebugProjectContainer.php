...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'dbservices' => 'getDbservicesService',
            'dbtestservices' => 'getDbtestservicesService',
            ...
            'fos_rest.serializer' => 'getJmsSerializerService',
            'fos_rest.templating' => 'getTemplatingService',
            'serializer' => 'getJmsSerializerService',
            'session.storage' => 'getSession_Storage_FilesystemService',
        );
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'dbservices' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Planiweb\RESTBundle\Services\DbServices A Planiweb\RESTBundle\Services\DbServices instance.
     */
    protected function getDbservicesService()
    {
        return $this->services['dbservices'] = new \Planiweb\RESTBundle\Services\DbServices($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'dbtestservices' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Planiweb\RESTBundle\Tests\Services\DbTestServices A Planiweb\RESTBundle\Tests\Services\DbTestServices instance.
     */
    protected function getDbtestservicesService()
    {
        return $this->services['dbtestservices'] = new \Planiweb\RESTBundle\Tests\Services\DbTestServices($this->get('dbservices'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'Planiweb_test', 'host' => '127.0.0.1', 'port' => 8889, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_fec5a2b0f012929b481728e6934657e4');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_fec5a2b0f012929b481728e6934657e4');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_fec5a2b0f012929b481728e6934657e4');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Volumes/Macintosh HD/Sites/Planiweb/backend/src/Planiweb/ModelBundle/Entity')), 'Planiweb\\ModelBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('PlaniwebModelBundle' => 'Planiweb\\ModelBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/Resources');
    }
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/jms_serializer'));
    ...
    {
        return $this->services['jms_serializer.json_deserialization_visitor'] = new \JMS\Serializer\JsonDeserializationVisitor($this->get('jms_serializer.naming_strategy'), $this->get('jms_serializer.object_constructor'));
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer', 'Symfony\\Bundle\\SecurityBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer', 'Symfony\\Bundle\\TwigBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer', 'Symfony\\Bundle\\MonologBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/monolog-bundle/Symfony/Bundle/MonologBundle/Resources/config/serializer', 'Symfony\\Bundle\\SwiftmailerBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/config/serializer', 'Symfony\\Bundle\\AsseticBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/assetic-bundle/Symfony/Bundle/AsseticBundle/Resources/config/serializer', 'Doctrine\\Bundle\\DoctrineBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/config/serializer', 'Sensio\\Bundle\\FrameworkExtraBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer', 'Planiweb\\RESTBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/src/Planiweb/RESTBundle/Resources/config/serializer', 'Doctrine\\Bundle\\FixturesBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/doctrine/doctrine-fixtures-bundle/Doctrine/Bundle/FixturesBundle/Resources/config/serializer', 'JMS\\SerializerBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer', 'FOS\\RestBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer', 'Planiweb\\ModelBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/src/Planiweb/ModelBundle/Resources/config/serializer', 'Symfony\\Bundle\\WebProfilerBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer', 'Sensio\\Bundle\\DistributionBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer', 'Sensio\\Bundle\\GeneratorBundle' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'));
    ...
    {
        return $this->services['jms_serializer.object_constructor'] = new \JMS\Serializer\Construction\DoctrineObjectConstructor($this->get('doctrine'), new \JMS\Serializer\Construction\UnserializeObjectConstructor());
    }
    ...
    {
        $this->services['jms_serializer.xml_deserialization_visitor'] = $instance = new \JMS\Serializer\XmlDeserializationVisitor($this->get('jms_serializer.naming_strategy'), $this->get('jms_serializer.object_constructor'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/logs/test.log', 100, true);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $k = new \Planiweb\RESTBundle\Services\Security\Http\Authentication\AuthenticationSuccessHandler($d, array('login_path' => '_demo_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Volumes/Macintosh HD/Sites/Planiweb/backend/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Volumes/Macintosh HD/Sites/Planiweb/backend/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Volumes/Macintosh HD/Sites/Planiweb/backend/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Volumes/Macintosh HD/Sites/Planiweb/backend/src/Planiweb/RESTBundle/Resources/views', 'PlaniwebREST');
        $instance->addPath('/Volumes/Macintosh HD/Sites/Planiweb/backend/src/Planiweb/ModelBundle/Resources/views', 'PlaniwebModel');
        $instance->addPath('/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/Resources/views');
        $instance->addPath('/Volumes/Macintosh HD/Sites/Planiweb/backend/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    /**
     * Gets the fos_rest.inflector service alias.
     *
     * @return FOS\RestBundle\Util\Inflector\DoctrineInflector An instance of the fos_rest.inflector.doctrine service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test',
            'kernel.logs_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/logs',
            'kernel.bundles' => array(
                ...
                'PlaniwebRESTBundle' => 'Planiweb\\RESTBundle\\PlaniwebRESTBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle',
                'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle',
                'PlaniwebModelBundle' => 'Planiweb\\ModelBundle\\PlaniwebModelBundle',
            ...
            'debug.container.dump' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/sessions',
            ...
            'router.resource' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/assetic',
            ...
            'assetic.read_from' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/../web',
            'assetic.write_to' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => '/Volumes/Macintosh HD/Sites/Planiweb/backend/app/cache/test/fos_rest',
