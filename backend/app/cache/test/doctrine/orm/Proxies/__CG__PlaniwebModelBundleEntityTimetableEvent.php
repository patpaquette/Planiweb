 ...
 */
class TimetableEvent extends \Planiweb\ModelBundle\Entity\TimetableEvent implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'start_time', 'end_time', 'day', 'course');
    }
