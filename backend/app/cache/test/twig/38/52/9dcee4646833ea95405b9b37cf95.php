...
/* PlaniwebModelBundle:CourseActivity:edit.html.twig */
class __TwigTemplate_38529dcee4646833ea95405b9b37cf95 extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>CourseActivity edit</h1>

    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("course_activity_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "PlaniwebModelBundle:CourseActivity:edit.html.twig";
    }
